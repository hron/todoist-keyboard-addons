...
const SHORTCUT_DEFAULTS = [
  ...
  {
    id: "moveToTop",
    name: "Move task to top",
    description: "Move the focused task to the top of the list",
    section: "taskList",
    shortcut: {
      key: "Home",
      code: "Home",
      ...
      shiftKey: true,
      metaKey: false,
      label: "Alt+Shift+Home",
    },
  },
  {
    id: "moveToBottom",
    name: "Move task to bottom",
    description: "Move the focused task to the bottom of the list",
    section: "taskList",
    shortcut: {
      key: "End",
      code: "End",
